            ...
            <div class="col-xs-5">
               <label>Select Bus Number</label>
                <select  id="busno" name="busno"  class="form-control select2" style="width: 100%;">
                  ...
                  <option value='1'>8789</option>
                  <option value='2'>3168</option>
                  <option value='3'>3228</option>
                  <option value='4'>3050</option>
              ...
              <div class="form-group">
                ...
                <select id='routes[]' name='routes[]'  class="form-control select2" multiple="multiple" data-placeholder="Select routes" style="width: 100%;">
                  ...
                  <option value="1">VENJARAMOODU</option>
                  <option value="2">VEMBAYAM</option>
                  <option value="3">KAZAKOOTOM</option>
                  <option value="4">VEMBAYAM</option>
                  <option value="12">KOLLAM</option>
                  <option value="8">PATHANAMTITTA</option>
                  <option value="7">ADOOR</option>
                  <option value="5">KIZHAKKEKOTA</option>
                  <option value="10">THAMPANOOR</option>
